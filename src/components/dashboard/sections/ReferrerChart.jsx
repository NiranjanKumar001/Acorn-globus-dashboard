...
const bars = [
  { id: 1, height: 130, logo: 'behance' },
  { id: 2, height: 170, logo: 'dribbble' },
  { id: 3, height: 100, logo: 'google' },
  { id: 4, height: 80, logo: 'instagram' },
  { id: 5, height: 140, logo: 'other' },
]

export default function ReferrerChart() {
  return (
    <div className="bg-[#F5F5F5] rounded-2xl p-5 h-full flex flex-col min-h-[320px]">
      {/* Header */}
      <div className="flex items-center justify-between mb-4">
        ...
        <button className="flex items-center gap-2 text-[13px] text-gray-600 border border-gray-300 rounded-full px-4 py-1.5 hover:bg-white bg-white">
          Filters
      ...
      <div className="flex-1 flex items-end justify-center gap-3 pb-4">
        {bars.map((bar) => (
          <div key={bar.id} className="flex flex-col items-center justify-end">
            ...
            <div 
              className="w-12 rounded-xl overflow-hidden relative"
