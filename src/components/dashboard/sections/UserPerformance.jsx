          ...
          <div key={user.id} className={`${
            ...
            <div className="sm:grid sm:grid-cols-[140px_95px_100px_50px_50px_70px_30px] sm:items-center flex items-center sm:gap-0 gap-5 sm:justify-between w-full">
              ...
              <div className="sm:w-[100px] min-w-0 flex items-center sm:gap-1 gap-1 justify-center">
                <span className={`w-5 h-5  rounded-lg ${user.salesBg} ${user.salesTextColor || 'text-black'} text-[9px] sm:text-[11px] font-semibold flex items-center justify-center`}>
                  {user.sales}
                </span>
              ...
              <div className="hidden sm:flex items-center gap-1 min-w-[60px]">
                <span className="w-5 h-5 rounded-lg bg-[#1F2937] text-white text-[11px] font-semibold flex items-center justify-center">
                  {user.wl.wins}
                </span>
                <span className="w-6 h-6 rounded-lg bg-gray-100 text-gray-600 text-[11px] font-semibold flex items-center justify-center">
                  {user.wl.losses}
              ...
              <div className="mt-1 pt-0.5 border-t border-gray-100">
                ...
                <div className="mb-2">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 w-full">
                    ...
                    <div 
                      className="rounded-xl p-2 flex-1 sm:w-auto sm:max-w-[260px] sm:flex-auto relative overflow-hidden border border-pink-200 flex flex-col bg-white "
                    >
                    ...
                    <div className="w-full sm:w-[300px] grid grid-cols-1 gap-1 sm:flex sm:flex-col">
                      {/* Top Row - Instagram and Google+Meta */}
                      <div className="grid grid-cols-2 gap-2 sm:flex sm:gap-2">
                        {/* Instagram Card */}
                        <div className="bg-white rounded-xl p-2 flex-1 sm:max-w-[180px] border border-pink-200 flex flex-col">
                        ...
                        <div className="flex flex-col gap-2 flex-1 sm:max-w-[110px]">
                          ...
                          <div className="rounded-xl p-1.5 border border-gray-200 bg-white">
                          ...
                          {/* Meta/Flickr Card */}
                          <div className="bg-white rounded-xl p-1.5 border border-gray-200">
