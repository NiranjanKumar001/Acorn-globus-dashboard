...
export default function TopSalesCard() {
  ...
  const shadow = isDesktop ? '0 10px 4px -2px rgba(0, 0, 0, 0.2), 0 -10px 4px -2px rgba(0, 0, 0, 0.15), 0 0 0 2px rgba(0, 0, 0, 0.12)' : undefined;
  return (
    <div className="bg-white rounded-2xl px-4 py-2 min-w-[180px] border border-gray-300" style={{ boxShadow: shadow }}>
      {/* Label */}
